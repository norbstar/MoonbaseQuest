...
namespace Interactables.Bow
{
    ...
    public class OriginalBowInteractableManager : FocusableInteractableManager
    {
        private static string className = MethodBase.GetCurrentMethod().DeclaringType.Name;

        [Header("Components")]
        [SerializeField] MeshRenderer actuationZone;
        [SerializeField] OnTriggerHandler actuatorHandler;
        ...
        void Update()
        {
            ...
            if (isTriggering && (triggerController != null))
            {
                ...
                lineRendererHelper.ConfigLine(transform.position, triggerController.transform.position);
            }

            lineRendererHelper.Active = isTriggering;
